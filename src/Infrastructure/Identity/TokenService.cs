...
using GAO.WebApi.Application.Identity.Tokens;
using GAO.WebApi.Infrastructure.Auth;
using GAO.WebApi.Infrastructure.Auth.Jwt;
...
internal class TokenService : ITokenService
{
    ...
    private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
        new List<Claim>
        {
            ...
            new(GAOClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(GAOClaims.IpAddress, ipAddress),
            new(GAOClaims.Tenant, _currentTenant!.Id),
            new(GAOClaims.ImageUrl, user.ImageUrl ?? string.Empty),
