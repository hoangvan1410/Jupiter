...
{
    [HttpPost("search")]
    [MustHavePermission(GAOAction.Search, GAOResource.Products)]
    ...
    [HttpGet("{id:guid}")]
    [MustHavePermission(GAOAction.View, GAOResource.Products)]
    ...
    [HttpPost]
    [MustHavePermission(GAOAction.Create, GAOResource.Products)]
    ...
    [HttpPut("{id:guid}")]
    [MustHavePermission(GAOAction.Update, GAOResource.Products)]
    ...
    [HttpDelete("{id:guid}")]
    [MustHavePermission(GAOAction.Delete, GAOResource.Products)]
    ...
    [HttpPost("export")]
    [MustHavePermission(GAOAction.Export, GAOResource.Products)]
