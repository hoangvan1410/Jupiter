using GAO.WebApi.Application.Identity.Roles;
...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(GAOAction.View, GAOResource.Roles)]
    ...
    [MustHavePermission(GAOAction.View, GAOResource.RoleClaims)]
    ...
    [MustHavePermission(GAOAction.Update, GAOResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(GAOAction.Create, GAOResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(GAOAction.Delete, GAOResource.Roles)]
